...
$(function() {
    $('.box-body').on('click', '.selectLink', function() {
        ...
        $(this).next('.selectDropdown').css({left: position.left}).slideToggle(function() {
...
$("body").click(function (e) {
    if(!$(e.target).is('.selectLink') && !$(e.target).is('.selectLink span')) {
        $('.box-body').find('.selectLink.opened').find('span').addClass('fa-angle-down').removeClass('fa-angle-up');
        $('.box-body').find('.selectLink.opened').removeClass("opened");
