...
class PromoCodeRedemptionReportControllerTest extends WebTestCase
{
     /**
     * {@inheritDoc}
     */
    ...
    public function testIndexAction()
    {
        ...
        $crawler = $client->request('POST', '/admin/promo-code-redemption/list');
        $this->assertEquals('Dhi\AdminBundle\Controller\PromoCodeRedemptionReportController::indexAction', $client->getRequest()->attributes->get('_controller'));
        $this->assertEquals(1, $crawler->filter('html:contains("Partner PromoCode Redemption Report")')->count());  
