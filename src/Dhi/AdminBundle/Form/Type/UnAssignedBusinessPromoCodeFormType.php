...
class UnAssignedBusinessPromoCodeFormType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('businessValue','text')
    ...
    public function getName() {
        return 'dhi_admin_unassigned_business_promo_code';
    }

    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Dhi\AdminBundle\Entity\BusinessPromoCodes'
        ));
    }
}